...
const (
	...
	ConfigServiceName = "schema.v1.ConfigService"
)
...
const (
	...
	ConfigServiceGetConfigProcedure = "/schema.v1.ConfigService/GetConfig"
)

// ConfigServiceClient is a client for the schema.v1.ConfigService service.
type ConfigServiceClient interface {
	GetConfig(context.Context, *connect.Request[v1.GetConfigRequest]) (*connect.Response[v1.GetConfigResponse], error)
}

// NewConfigServiceClient constructs a client for the schema.v1.ConfigService service. By default,
...
func NewConfigServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ConfigServiceClient {
	...
	configServiceMethods := v1.File_schema_v1_config_proto.Services().ByName("ConfigService").Methods()
...
// GetConfig calls schema.v1.ConfigService.GetConfig.
...
// ConfigServiceHandler is an implementation of the schema.v1.ConfigService service.
...
func NewConfigServiceHandler(svc ConfigServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/schema.v1.ConfigService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedConfigServiceHandler) GetConfig(context.Context, *connect.Request[v1.GetConfigRequest]) (*connect.Response[v1.GetConfigResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("schema.v1.ConfigService.GetConfig is not implemented"))
}
